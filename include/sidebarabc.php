...
<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#inquiry" role="button" aria-expanded="false" aria-controls="charts">
                ...
                <div class="collapse" id="inquiry">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="inquiry.php" class="nav-link">Inquiry</a>
                        </li>
                        <li class="nav-item">
                            <a href="todayinquiry.php" class="nav-link">Today Inquiry</a>
                        </li>
                        <li class="nav-item">
                            <a href="lastweek.php" class="nav-link">Last Week Inquiry</a>
                        </li>
                        <li class="nav-item">
                            <a href="todayfollow.php" class="nav-link">Today Follow Up</a>
                        </li>
                        <li class="nav-item">
                            <a href="weekfollow.php" class="nav-link">last Week Follow Up</a>
                        </li>
                        <!--<li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#student" role="button" aria-expanded="false" aria-controls="emails">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#payment" role="button" aria-expanded="false" aria-controls="tables">
                    <i class="link-icon" data-feather="layout"></i>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="errorPages">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="dropzone.php" class="nav-link">404</a>
                        </li>
                        <li class="nav-item">
