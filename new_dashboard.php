...
$sql = "SELECT add_accounts.type,add_accounts.name,sum(amount) as total FROM `transactions` join add_accounts on add_accounts.id=transactions.from_account WHERE transactions.user_id=4 GROUP BY add_accounts.type";
